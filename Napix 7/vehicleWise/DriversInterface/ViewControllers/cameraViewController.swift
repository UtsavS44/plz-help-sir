...
class cameraViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    var isRedFaceVisible = true
    var isGreenFaceVisible = true
    ...
    override func viewDidLoad() {
        ...
        redFace.image = UIImage(named: "RedImageNotFound")
        print(emojiPic!)
    ...
    func captureOutput(_ output: AVCaptureOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection) {
        ...
        do {
            ...
            if outputString1 == "face detected" {
                ...
                redFace.isHidden = false
                emojiPic.isHidden = true
                playFaceSound()
                self.emojiPic.image = UIImage(named: "RedImageNotFound") // Set the image to red
                // self.emojiPic.isHidden = false
                print(self.emojiPic!)
            }
        } catch {
